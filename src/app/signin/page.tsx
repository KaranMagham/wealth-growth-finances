...
export default function SignInPage() {
  ...
  const canSubmit = emailValid && password.length >= 8 && status !== 'loading'
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    // Placeholder for backend sign-in flow
              ...
              <div className="rounded-[32px] border border-[#334155] bg-[#0F172A]/90 p-8 shadow-[0_0_50px_rgba(16,185,129,0.12)] sm:p-10">
                ...
                <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center justify-between gap-4 text-sm">
                    ...
                    <Link href="/support" className="font-semibold text-[#10B981] hover:text-[#34d399]">
                      Forgot Password?
                    </Link>
                  </div>
